...
- **Sync Waves:** Dependencies are handled declaratively via `argocd.argoproj.io/sync-wave` annotations
- **ApplicationSets:** Dynamic application generation from templates
...
- [Observability Model](observability-model.md): How Observability as Code works

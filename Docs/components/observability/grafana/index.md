...
Grafana is bundled inside the kube-prometheus-stack deployment. Its values are managed in that chart; see the Prometheus component page for the generated values table.

...
![Version: 0.14.0](https://img.shields.io/badge/Version-0.14.0-informational?style=flat-square)  ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)  [![Homepage](https://img.shields.io/badge/Homepage-blue)](https://github.com/pyrra-dev/pyrra)
...
|-----|--------|--------|--------|----------|
| **Prometheus Targets Up** | 99.0% | 6h | `up` metric availability | `K8s/observability/slo/prometheus-targets-up-slo.yaml` |
| **Loki Ingest Availability** | 99.0% | 6h | Successful log ingestion rate | `K8s/observability/slo/loki-ingest-availability-slo.yaml` |
...
All SLO definitions are in `K8s/observability/slo/` and deployed through the observability ApplicationSet.
...
2. Add the file to `K8s/observability/slo/kustomization.yaml`
3. Commit and push to Git
4. ArgoCD syncs the SLO automatically
5. Pyrra generates PrometheusRules within minutes
6. View the new SLO in the Pyrra dashboard

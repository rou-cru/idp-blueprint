...
![Version: 2.4.12](https://img.shields.io/badge/Version-2.4.12-informational?style=flat-square)  ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)  [![Homepage](https://img.shields.io/badge/Homepage-blue)](https://argoproj.github.io/events)
...
See [CI/CD Model](../../../architecture/cicd.md) for how Argo Events integrates into the platform automation.
...
|------|----------|---------|
| **Webhook** | HTTP endpoints for external systems | GitHub push events, GitLab merge requests |
| **Calendar** | Cron-like scheduled events | Periodic backups, nightly jobs |
| **Resource** | Kubernetes resource changes | Pod failures, ConfigMap updates |
...
| **Redis** | Cache and pub/sub | Session events, cache invalidation |

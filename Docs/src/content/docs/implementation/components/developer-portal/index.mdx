...
Backstage centralizes the developer experience (catalog, docs, orchestration) and
...
- Deployment: official Backstage Helm chart (`K8s/backstage/backstage/*`) with its
  own Postgres + PVC

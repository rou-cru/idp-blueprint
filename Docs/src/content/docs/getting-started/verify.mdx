...
- Projects in the left sidebar (e.g., `cicd`, `observability`, `backstage`) - these correspond to the [fuses](../overview/#feature-toggles-fuses) enabled in your `config.toml`.

...
This page lists every platform contract: what it is, its type, where it lives in Git,
how it's enforced, and what breaks if you violate it.
...
- Validations: `Scripts/validate-consistency.sh` (labels, priority coverage, deprecated
  APIs)
...
Keep this page updated when introducing new stacks or toggles. Every new capability
needs an explicit, documented contract.

...
![Resource Quota Usage](../assets/images/operate/resourcequota-status.png) _Screenshot
of `kubectl describe resourcequota -n observability` showing current usage vs. hard
limits_

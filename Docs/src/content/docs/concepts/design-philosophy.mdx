...
> **Source:**
> [design-philosophy-flow.d2](../assets/diagrams/concepts/design-philosophy-flow.d2)
...
- [Observability Model](../concepts/observability): How Observability as Code works

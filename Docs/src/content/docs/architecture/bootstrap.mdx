...
The components are the same as in the infrastructure core. This page focuses on their **lifecycle over time** (bootstrap sequence). For the **structural view** of the same components, see [Infrastructure Core](infrastructure).
:::

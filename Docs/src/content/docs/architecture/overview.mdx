...
> **Source:** [overview-container-view.d2](../assets/diagrams/architecture/overview-container-view.d2)
...
- **Bootstrap and infrastructure**: [IT directory architecture](infrastructure)
- **GitOps application layer**: [K8s directory architecture](applications)
- **Secrets and PKI**: [Secrets management architecture](secrets)
- **Policy and governance**: [Security & policy model](../concepts/security-policy-model)
- **Observability stack**: [Observability architecture](observability)
- **CI/CD architecture**: [CI/CD architecture](cicd)

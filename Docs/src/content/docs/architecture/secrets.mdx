...
See [Components - Vault](/implementation/components/infrastructure/vault/) and
[Components - External Secrets](/implementation/components/infrastructure/external-secrets/) for
details.

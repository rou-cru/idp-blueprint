...
- **ApplicationSets**: Generate Applications dynamically from templates, enabling patterns like
  ...
  [`GitOps, Policy, and Eventing`](../../concepts/gitops-model) for the App‑of‑AppSets model)
...
See [GitOps Model](../../concepts/gitops-model) for how ArgoCD orchestrates the entire platform.
